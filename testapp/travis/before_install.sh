...
echo "slapd slapd/domain string testapp18.local" | debconf-set-selections

apt-get -y install slapd ldap-utils

ldapadd -x -D cn=admin,dc=testapp18,dc=local -w passjelix -f testapp/vagrant/ldap_conf.ldif
