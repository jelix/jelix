...
', $this->builder->getJsContent());
    ...
    function testOutputChoice(){
        ...
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_0" value="new" onclick="jForms.getForm(\'\').getControl(\'status\').activate(\'new\')"/>New</label>'."\n".'</li>'."\n";
...
', $this->builder->getJsContent());
        ...
        $expected = '<ul class="jforms-choice jforms-ctl-status" >'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_0" value="new" checked="checked" onclick="jForms.getForm(\'\').getControl(\'status\').activate(\'new\')"/>New</label>'."\n".'</li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_1" value="assigned" onclick="jForms.getForm(\'\').getControl(\'status\').activate(\'assigned\')"/>Assigned</label>'."\n";
        $expected .= ' <span class="jforms-item-controls"><label class="jforms-label jforms-required" for="'.$this->formname.'_nom">Name</label>'."\n".' <input type="text" name="nom" id="'.$this->formname.'_nom" class="jforms-ctrl-input jforms-required" value=""/>'."\n".'</span>'."\n";
        $expected .= ' <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_prenom">Firstname</label>'."\n".' <input type="text" name="prenom" id="'.$this->formname.'_prenom" class="jforms-ctrl-input" value="robert"/>'."\n".'</span>'."\n";
        $expected .= '</li>'."\n";
...
', $this->builder->getJsContent());
        ...
        $expected = '<ul class="jforms-choice jforms-ctl-status" >'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_0" value="new" readonly="readonly" onclick="jForms.getForm(\'\').getControl(\'status\').activate(\'new\')"/>New</label>'."\n".'</li>'."\n";
