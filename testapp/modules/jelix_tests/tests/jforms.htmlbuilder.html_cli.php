...
//]]>
    ...
    function testOutputInput(){
        ...
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input" value=""/>', $out);
...
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input" value="toto"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
...
', $this->builder->getJsContent());
        ...
        $this->form->addControl($ctrl);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->required=true;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input jforms-required" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.required = true;
...
', $this->builder->getJsContent());
        ...
        $ctrl->required=false;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" readonly="readonly" class="jforms-ctrl-input jforms-readonly" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->help='some help';
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input" value="laurent"/><span class="jforms-help" id="jforms_formtest1-help"><span>some help</span></span>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->help="some \nhelp with ' and\nline break.";
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input" value="laurent"/><span class="jforms-help" id="jforms_formtest1-help">'."<span>some \nhelp with ' and\nline break.</span>".'</span>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" title="ceci est un tooltip" class="jforms-ctrl-input" value="laurent"/><span class="jforms-help" id="jforms_formtest1-help"><span>some help</span></span>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="text" name="input1" id="'.$this->formname.'_input1" class="jforms-ctrl-input" maxlength="5" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'input1\', \'Votre nom\');
c.maxLength = \'5\';
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
    ...
    function testOutputCheckbox(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk1" id="'.$this->formname.'_chk1" class="jforms-ctrl-checkbox" value="1"/>', $out);
...
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk1" id="'.$this->formname.'_chk1" class="jforms-ctrl-checkbox" checked="checked" value="1"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlBoolean(\'chk1\', \'Une option\');
c.errInvalid=\'"Une option" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk2" id="'.$this->formname.'_chk2" class="jforms-ctrl-checkbox" value="1"/>', $out);
...
', $this->builder->getJsContent());
        ...
        $this->form->addControl($ctrl);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk2" id="'.$this->formname.'_chk2" class="jforms-ctrl-checkbox" checked="checked" value="1"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlBoolean(\'chk2\', \'Une option\');
c.errInvalid=\'"Une option" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
...
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk2" id="'.$this->formname.'_chk2" readonly="readonly" class="jforms-ctrl-checkbox jforms-readonly" value="1"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlBoolean(\'chk2\', \'Une option\');
c.errInvalid=\'"Une option" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk2" id="'.$this->formname.'_chk2" readonly="readonly" class="jforms-ctrl-checkbox jforms-readonly" checked="checked" value="1"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlBoolean(\'chk2\', \'Une option\');
c.errInvalid=\'"Une option" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="checkbox" name="chk2" id="'.$this->formname.'_chk2" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-checkbox jforms-readonly" checked="checked" value="1"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlBoolean(\'chk2\', \'Une option\');
c.errInvalid=\'"Une option" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
...
', $this->builder->getJsContent());
    ...
    function testOutputTextarea(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="textarea1" id="'.$this->formname.'_textarea1" class="jforms-ctrl-textarea" rows="5" cols="40"></textarea>', $out);
...
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="textarea1" id="'.$this->formname.'_textarea1" class="jforms-ctrl-textarea" rows="5" cols="40">laurent</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'textarea1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="textarea1" id="'.$this->formname.'_textarea1" readonly="readonly" class="jforms-ctrl-textarea jforms-readonly" rows="5" cols="40">laurent</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'textarea1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="textarea1" id="'.$this->formname.'_textarea1" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-textarea jforms-readonly" rows="5" cols="40">laurent</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'textarea1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->rows=20;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="textarea1" id="'.$this->formname.'_textarea1" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-textarea jforms-readonly" rows="20" cols="40">laurent</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'textarea1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->cols=60;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="textarea1" id="'.$this->formname.'_textarea1" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-textarea jforms-readonly" rows="20" cols="60">laurent</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'textarea1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
    ...
    function testOutputSecret(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd" id="'.$this->formname.'_passwd" class="jforms-ctrl-secret" value=""/>', $out);
...
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd" id="'.$this->formname.'_passwd" class="jforms-ctrl-secret" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlSecret(\'passwd\', \'mot de passe\');
c.errInvalid=\'"mot de passe" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd" id="'.$this->formname.'_passwd" readonly="readonly" class="jforms-ctrl-secret jforms-readonly" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlSecret(\'passwd\', \'mot de passe\');
c.errInvalid=\'"mot de passe" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd" id="'.$this->formname.'_passwd" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-secret jforms-readonly" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlSecret(\'passwd\', \'mot de passe\');
c.errInvalid=\'"mot de passe" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd" id="'.$this->formname.'_passwd" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-secret jforms-readonly" maxlength="10" value="laurent"/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlSecret(\'passwd\', \'mot de passe\');
c.maxLength = \'10\';
c.minLength = \'5\';
c.errInvalid=\'"mot de passe" field is invalid\';
...
', $this->builder->getJsContent());
    ...
    function testOutputSecretConfirm(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd_confirm" id="'.$this->formname.'_passwd_confirm" class="jforms-ctrl-secretconfirm" value=""/>', $out);
...
', $this->builder->getJsContent());
        ...
        $ctrl->required = true;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd_confirm" id="'.$this->formname.'_passwd_confirm" class="jforms-ctrl-secretconfirm jforms-required" value=""/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlConfirm(\'passwd_confirm\', \'confirmation mot de passe\');
c.required = true;
...
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd_confirm" id="'.$this->formname.'_passwd_confirm" readonly="readonly" class="jforms-ctrl-secretconfirm jforms-readonly" value=""/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlConfirm(\'passwd_confirm\', \'confirmation mot de passe\');
c.errInvalid=\'"confirmation mot de passe" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="password" name="passwd_confirm" id="'.$this->formname.'_passwd_confirm" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-secretconfirm jforms-readonly" value=""/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlConfirm(\'passwd_confirm\', \'confirmation mot de passe\');
c.errInvalid=\'"confirmation mot de passe" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
    ...
    function testOutputUpload(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="file" name="upload1" id="'.$this->formname.'_upload1" class="jforms-ctrl-upload" value=""/>', $out);
...
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="file" name="upload1" id="'.$this->formname.'_upload1" readonly="readonly" class="jforms-ctrl-upload jforms-readonly" value=""/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'upload1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<input type="file" name="upload1" id="'.$this->formname.'_upload1" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-upload jforms-readonly" value=""/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'upload1\', \'Votre nom\');
c.errInvalid=\'"Votre nom" field is invalid\';
jFormsJQ.tForm.addControl(c);
', $this->builder->getJsContent());
...
<input type="hidden" name="hidden2" id="'.$this->formname.'_hidden2" value="toto"/>
    ...
    function testOutputCaptcha(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<span class="jforms-captcha-question">'.htmlspecialchars($ctrl->question).'</span> <input type="text" name="cap" id="'.$this->formname.'_cap" class="jforms-ctrl-captcha jforms-required" value=""/>', $out);
...
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<span class="jforms-captcha-question">'.htmlspecialchars($ctrl->question).'</span> <input type="text" name="cap" id="'.$this->formname.'_cap" class="jforms-ctrl-captcha" value=""/>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'cap\', \'captcha for security\');
c.required = true;
c.errRequired=\'"captcha for security" field is required\';
c.errInvalid=\'"captcha for security" field is invalid\';
...
', $this->builder->getJsContent());
        ...
        $ctrl->help='some help';
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<span class="jforms-captcha-question">'.htmlspecialchars($ctrl->question).'</span> <input type="text" name="cap" id="'.$this->formname.'_cap" class="jforms-ctrl-captcha jforms-required" value=""/><span class="jforms-help" id="jforms_formtest1-help"><span>some help</span></span>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'cap\', \'captcha for security\');
c.required = true;
c.errRequired=\'"captcha for security" field is required\';
c.errInvalid=\'"captcha for security" field is invalid\';
...
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<span class="jforms-captcha-question">'.htmlspecialchars($ctrl->question).'</span> <input type="text" name="cap" id="'.$this->formname.'_cap" title="ceci est un tooltip" class="jforms-ctrl-captcha jforms-required" value=""/><span class="jforms-help" id="jforms_formtest1-help"><span>some help</span></span>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'cap\', \'captcha for security\');
c.required = true;
c.errRequired=\'"captcha for security" field is required\';
c.errInvalid=\'"captcha for security" field is invalid\';
...
', $this->builder->getJsContent());
    ...
    function testOutputHtmleditor(){
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="contenu" id="'.$this->formname.'_contenu" class="jforms-ctrl-htmleditor" rows="5" cols="40">&lt;p&gt;Ceci est un contenu&lt;/p&gt;</textarea>', $out);
...
', $this->builder->getJsContent());
        ...
        $ctrl->setReadOnly(true);
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="contenu" id="'.$this->formname.'_contenu" readonly="readonly" class="jforms-ctrl-htmleditor jforms-readonly" rows="5" cols="40">&lt;p&gt;Ceci est un contenu&lt;/p&gt;</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'contenu\', \'Texte\');
c.errInvalid=\'"Texte" field is invalid\';
jFormsJQ.tForm.addControl(c);
jelix_wymeditor_default("jforms_formtest1_contenu","jforms_formtest1");
', $this->builder->getJsContent());
        ...
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="contenu" id="'.$this->formname.'_contenu" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-htmleditor jforms-readonly" rows="5" cols="40">&lt;p&gt;Ceci est un contenu&lt;/p&gt;</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'contenu\', \'Texte\');
c.errInvalid=\'"Texte" field is invalid\';
jFormsJQ.tForm.addControl(c);
jelix_wymeditor_default("jforms_formtest1_contenu","jforms_formtest1");
', $this->builder->getJsContent());
        ...
        $ctrl->rows=20;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="contenu" id="'.$this->formname.'_contenu" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-htmleditor jforms-readonly" rows="20" cols="40">&lt;p&gt;Ceci est un contenu&lt;/p&gt;</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'contenu\', \'Texte\');
c.errInvalid=\'"Texte" field is invalid\';
jFormsJQ.tForm.addControl(c);
jelix_wymeditor_default("jforms_formtest1_contenu","jforms_formtest1");
', $this->builder->getJsContent());
        ...
        $ctrl->cols=60;
        ob_start();$this->builder->outputControl($ctrl);$out = ob_get_clean();
        $this->assertEqualOrDiff('<textarea name="contenu" id="'.$this->formname.'_contenu" readonly="readonly" title="ceci est un tooltip" class="jforms-ctrl-htmleditor jforms-readonly" rows="20" cols="60">&lt;p&gt;Ceci est un contenu&lt;/p&gt;</textarea>', $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'contenu\', \'Texte\');
c.errInvalid=\'"Texte" field is invalid\';
jFormsJQ.tForm.addControl(c);
jelix_wymeditor_default("jforms_formtest1_contenu","jforms_formtest1");
