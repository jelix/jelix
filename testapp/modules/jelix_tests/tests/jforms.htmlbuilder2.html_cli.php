...
class UTjformsHTMLBuilder2 extends jUnitTestCaseDb {
    ...
    function testOutputGroup(){
        ...
        $expected .= '<td><input type="text" name="nom" id="'.$this->formname.'_nom" class="jforms-ctrl-input jforms-required" value=""/></td></tr>'."\n";
        $expected .= '<tr><th scope="row"><label class="jforms-label" for="'.$this->formname.'_prenom">Your firstname</label></th>'."\n";
        $expected .= '<td><input type="text" name="prenom" id="'.$this->formname.'_prenom" class="jforms-ctrl-input" value="robert"/></td></tr>'."\n";
        $expected .= '<tr><th scope="row"><span class="jforms-label jforms-required">Vous êtes </span></th>'."\n";
        $expected .= '<td><span class="jforms-radio jforms-ctl-sexe"><input type="radio" name="sexe" id="'.$this->formname.'_sexe_0" value="h" class="jforms-ctrl-radiobuttons jforms-required"/><label for="'.$this->formname.'_sexe_0">un homme</label></span>';
        $expected .= '<span class="jforms-radio jforms-ctl-sexe"><input type="radio" name="sexe" id="'.$this->formname.'_sexe_1" value="f" class="jforms-ctrl-radiobuttons jforms-required"/><label for="'.$this->formname.'_sexe_1">une femme</label></span>';
        $expected .= '<span class="jforms-radio jforms-ctl-sexe"><input type="radio" name="sexe" id="'.$this->formname.'_sexe_2" value="no" class="jforms-ctrl-radiobuttons jforms-required"/><label for="'.$this->formname.'_sexe_2">je ne sais pas</label></span></td></tr>'."\n";
        $expected .= '<tr><th scope="row"><label class="jforms-label" for="'.$this->formname.'_mail">Votre mail</label></th>'."\n";
        $expected .= '<td><input type="text" name="mail" id="'.$this->formname.'_mail" class="jforms-ctrl-input" value=""/></td></tr>'."\n</table></fieldset>";
...
', $this->builder->getJsContent());
        ...
        $expected .= '<td><input type="text" name="nom" id="'.$this->formname.'_nom" readonly="readonly" class="jforms-ctrl-input jforms-readonly" value=""/></td></tr>'."\n";
        $expected .= '<tr><th scope="row"><label class="jforms-label" for="'.$this->formname.'_prenom">Your firstname</label></th>'."\n";
        $expected .= '<td><input type="text" name="prenom" id="'.$this->formname.'_prenom" readonly="readonly" class="jforms-ctrl-input jforms-readonly" value="robert"/></td></tr>'."\n";
        $expected .= '<tr><th scope="row"><span class="jforms-label">Vous êtes </span></th>'."\n";
        $expected .= '<td><span class="jforms-radio jforms-ctl-sexe"><input type="radio" name="sexe" id="'.$this->formname.'_sexe_0" value="h" readonly="readonly" class="jforms-ctrl-radiobuttons jforms-readonly"/><label for="'.$this->formname.'_sexe_0">un homme</label></span>';
        $expected .= '<span class="jforms-radio jforms-ctl-sexe"><input type="radio" name="sexe" id="'.$this->formname.'_sexe_1" value="f" readonly="readonly" class="jforms-ctrl-radiobuttons jforms-readonly"/><label for="'.$this->formname.'_sexe_1">une femme</label></span>';
        $expected .= '<span class="jforms-radio jforms-ctl-sexe"><input type="radio" name="sexe" id="'.$this->formname.'_sexe_2" value="no" readonly="readonly" class="jforms-ctrl-radiobuttons jforms-readonly"/><label for="'.$this->formname.'_sexe_2">je ne sais pas</label></span></td></tr>'."\n";
        $expected .= '<tr><th scope="row"><label class="jforms-label" for="'.$this->formname.'_mail">Votre mail</label></th>'."\n";
        $expected .= '<td><input type="text" name="mail" id="'.$this->formname.'_mail" readonly="readonly" class="jforms-ctrl-input jforms-readonly" value=""/></td></tr>'."\n</table></fieldset>";
        ob_start();$this->builder->outputControl($group);$out = ob_get_clean();
        $this->assertEqualOrDiff($expected, $out);
        $this->assertEqualOrDiff('c = new jFormsJQControlString(\'nom\', \'Your name\');
c.required = true;
...
', $this->builder->getJsContent());
    ...
    function testOutputChoice(){
        ...
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_1" value="assigned" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'assigned\')"/>Assigned</label>';
        $expected .= '  <span class="jforms-item-controls"><label class="jforms-label jforms-required" for="'.$this->formname.'_nom">Name</label> <input type="text" name="nom" id="'.$this->formname.'_nom" class="jforms-ctrl-input jforms-required" value=""/></span>'."\n";
        $expected .= ' <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_prenom">Firstname</label> <input type="text" name="prenom" id="'.$this->formname.'_prenom" class="jforms-ctrl-input" value="robert"/></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_2" value="closed" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'closed\')"/>Closed</label>';
        $expected .= '  <span class="jforms-item-controls"><label class="jforms-label jforms-required" for="'.$this->formname.'_reason">Reason </label>';
        $expected .= ' <select name="reason" id="'.$this->formname.'_reason" class="jforms-ctrl-menulist jforms-required" size="1"><option value="aa">fixed</option><option value="bb">won t fixed</option><option value="cc">later</option></select></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '</ul>'."\n";
...
', $this->builder->getJsContent());
        ...
        $expected = '<ul class="jforms-choice jforms-ctl-status" >'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_0" value="new" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'new\')"/>New</label> </li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_1" value="assigned" checked="checked" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'assigned\')"/>Assigned</label>';
        $expected .= '  <span class="jforms-item-controls"><label class="jforms-label jforms-required" for="'.$this->formname.'_nom">Name</label> <input type="text" name="nom" id="'.$this->formname.'_nom" class="jforms-ctrl-input jforms-required" value=""/></span>'."\n";
        $expected .= ' <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_prenom">Firstname</label> <input type="text" name="prenom" id="'.$this->formname.'_prenom" class="jforms-ctrl-input" value="robert"/></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_2" value="closed" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'closed\')"/>Closed</label>';
...
', $this->builder->getJsContent());
        ...
        $expected .= ' <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_prenom">Firstname</label> <input type="text" name="prenom" id="'.$this->formname.'_prenom" class="jforms-ctrl-input" value="robert"/></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_2" value="closed" checked="checked" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'closed\')"/>Closed</label>';
        $expected .= '  <span class="jforms-item-controls"><label class="jforms-label jforms-required" for="'.$this->formname.'_reason">Reason </label>';
        $expected .= ' <select name="reason" id="'.$this->formname.'_reason" class="jforms-ctrl-menulist jforms-required" size="1"><option value="aa">fixed</option><option value="bb">won t fixed</option><option value="cc">later</option></select></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '</ul>'."\n";
...
', $this->builder->getJsContent());
        ...
        $expected = '<ul class="jforms-choice jforms-ctl-status" >'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_0" value="new" readonly="readonly" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'new\')"/>New</label> </li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_1" value="assigned" readonly="readonly" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'assigned\')"/>Assigned</label>';
        $expected .= '  <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_nom">Name</label> <input type="text" name="nom" id="'.$this->formname.'_nom" readonly="readonly" class="jforms-ctrl-input jforms-readonly" value=""/></span>'."\n";
        $expected .= ' <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_prenom">Firstname</label> <input type="text" name="prenom" id="'.$this->formname.'_prenom" readonly="readonly" class="jforms-ctrl-input jforms-readonly" value="robert"/></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '<li><label><input type="radio" name="status" id="'.$this->formname.'_status_2" value="closed" checked="checked" readonly="readonly" onclick="jFormsJQ.getForm(\'\').getControl(\'status\').activate(\'closed\')"/>Closed</label>';
        $expected .= '  <span class="jforms-item-controls"><label class="jforms-label" for="'.$this->formname.'_reason">Reason </label>';
        $expected .= ' <select name="reason" id="'.$this->formname.'_reason" class="jforms-ctrl-menulist jforms-readonly" size="1"><option value="aa">fixed</option><option value="bb">won t fixed</option><option value="cc">later</option></select></span>'."\n";
        $expected .= '</li>'."\n";
        $expected .= '</ul>'."\n";
        ob_start();$this->builder->outputControl($choice);$out = ob_get_clean();
        $this->assertEqualOrDiff($expected, $out);
