 ...
 */
class mysqliDbTable extends jDbTable {
 ...
 * @subpackage db_driver
 */
class mysqliDbSchema extends jDbSchema {
    ...
    function _createTable($name, $columns, $primaryKey, $attributes=array()) {
        ...
        $table = new mysqliDbTable($name, $this);
    ...
    protected function _getTables() {
        ...
        while ($line = $rs->fetch ()){
            $results[$line->$col_name] = new mysqliDbTable($line->$col_name, $this);
        }
        return $results;
    }
}
