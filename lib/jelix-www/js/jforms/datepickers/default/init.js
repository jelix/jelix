...
function jelix_datepicker_default(control,locale,basePath, jqueryPath){
    ...
    if(typeof jQuery.ui == 'undefined')
        this._jsFiles.push(this._config.jqueryPath+'ui/ui.core.min.js');
    if(typeof jQuery.datepicker == 'undefined'){
        jQuery.include(this._config.jqueryPath+'themes/default/ui.datepicker.css');
        this._jsFiles.push(this._config.jqueryPath+'ui/ui.datepicker.min.js');
        var lang = locale.substr(0,2).toLowerCase();
        if(lang != 'en')
            this._jsFiles.push(this._config.jqueryPath+'ui/i18n/ui.datepicker-'+lang+'.js');
    }
