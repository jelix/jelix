$("document").ready( function () {
    ...
    var userGroupSelector = document.getElementById('user-list-group');
    if (userGroupSelector) {
        userGroupSelector.addEventListener('change', function (event) {
            $('#users-list').DataTable().draw();
        });
    }
