...
class pgsqlDbTable extends jDbTable
{
    ...
    protected function _loadColumns()
    {
        ...
        $sql = "SELECT a.attname, a.attnotnull, a.atthasdef, a.attlen, a.atttypmod,
                ...
                {$adColName}{$attIdentity}, co.contype AS primary, co.conname
        ...
        while ($line = $rs->fetch()) {
            ...
            if (is_string($default) && preg_match('/^nextval\(([^\)]*)\)$/', $default, $m)) {
                ...
                $col->autoIncrementFlavor = $default;
            } elseif ($version >= 10 && ($line->attidentity == 'a' || $line->attidentity == 'd')) {
                $col->autoIncrement = true;
                $col->default = '';
                $col->autoIncrementFlavor = $line->attidentity == 'a' ? 'GENERATED ALWAYS AS IDENTITY' : 'GENERATED BY DEFAULT AS IDENTITY';
            } elseif ($typeinfo[6]) {
                $col->autoIncrement = true;
                $col->default = '';
