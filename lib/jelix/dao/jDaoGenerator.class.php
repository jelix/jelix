...
* @subpackage dao
* @version    $Id:$
* @author     Croes G�ald, Laurent Jouanneau
...
* Adapt� et am�ior� pour Jelix par Laurent Jouanneau
*/

/**
* G��ateur d'une classe PHP correspondant �un objet DAO d�init dans une fichier xml
* de d�inition
*/
