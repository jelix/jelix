...
{
    /**
     * @var jSelectorClass|jSelectorIface Called selector
     */
     ...
     * __constructor.
     *
     * @param jSelectorClass|jSelectorIface $selector the selector of the class
     */
    ...
    protected function _getClassSelector()
    {
        ...
        if ($this->toSelector === null && $this->instance === null) {
            ...
            if (($this->fromSelector instanceof jSelectorClass) === true) {
