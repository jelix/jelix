...
class UTjtplexpr extends jUnitTestCase {
    ...
    protected $varexpr = array(
        ...
        '@aa@'=>'${jTplConfig::$localesGetter}(\'aa\')',
        '@aa.$ooo@'=>'${jTplConfig::$localesGetter}(\'aa.\'.$t->_vars[\'ooo\'].\'\')',
        '@aa~bbb@'=>'${jTplConfig::$localesGetter}(\'aa~bbb\')',
        '@aa~trc.$abcd.popo@'=>'${jTplConfig::$localesGetter}(\'aa~trc.\'.$t->_vars[\'abcd\'].\'.popo\')',
        '@$aa~trc.$abcd.popo@'=>'${jTplConfig::$localesGetter}(\'\'.$t->_vars[\'aa\'].\'~trc.\'.$t->_vars[\'abcd\'].\'.popo\')',
        '$aa.@trc.$abcd.popo@'=>'$t->_vars[\'aa\'].${jTplConfig::$localesGetter}(\'trc.\'.$t->_vars[\'abcd\'].\'.popo\')',
        '@aa~trc.234.popo@'=>'${jTplConfig::$localesGetter}(\'aa~trc.234.popo\')',
        '@aa~trc.23.4.popo@'=>'${jTplConfig::$localesGetter}(\'aa~trc.23.4.popo\')',
        '@aa~trc.23.4.list@'=>'${jTplConfig::$localesGetter}(\'aa~trc.23.4.list\')',
        ...
        '@abstract.as.break.case.catch.class.clone@'=>'${jTplConfig::$localesGetter}(\'abstract.as.break.case.catch.class.clone\')',
        '@const.continue.declare.default.do.echo.else.elseif.empty@'=>'${jTplConfig::$localesGetter}(\'const.continue.declare.default.do.echo.else.elseif.empty\')',
        '@exit.final.for.foreach.function.global.if.implements.instanceof@'=>'${jTplConfig::$localesGetter}(\'exit.final.for.foreach.function.global.if.implements.instanceof\')',
        '@interface.and.or.xor.new.private.public@'=>'${jTplConfig::$localesGetter}(\'interface.and.or.xor.new.private.public\')',
        '@protected.return.static.switch.throw.try.use.var.eval.while@'=>'${jTplConfig::$localesGetter}(\'protected.return.static.switch.throw.try.use.var.eval.while\')',
