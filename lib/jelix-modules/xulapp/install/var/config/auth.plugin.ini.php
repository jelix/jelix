...
on_error_action = "xulapp~default_login"
...
bad_ip_action = "xulapp~default_login"

enable_after_login_override = off
after_login =

enable_after_logout_override = off
after_logout = "xulapp~default_login"
...
; paramètres pour le driver ldap
;[ldap]
;query_user = (cn=%s)
;query_list = (cn=*)
;login_field = uid
...
;[ldapfields]
;// champs ldap =  proprieté de jUser
;cn = name
;sn = firstname
