 ...
 * @subpackage  forms
 * @deprecated
 * @see Jelix\Forms\Datasource\DynamicStaticDatasource
 */
class jFormsDynamicStaticDatasource extends jFormsDynamicDatasource
{
    ...
    protected function filterWithCriteria(\jFormsBase $form)
    {
        $args = array();
