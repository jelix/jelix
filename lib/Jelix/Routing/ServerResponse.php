...
abstract class ServerResponse
{
    ...
    /**
     * @var bool indicates if http headers have already been sent to the client
     */
    ...
    /**
     * @var bool Should we output only the headers or the entire response
     */
     ...
     *
     * @return bool true if the output is ok
     *
     ...
     * @param int    $overwrite false or 0 if the value should be set only if it doesn't still exist
     ...
     * @param bool  $cleanCacheHeaderTrue for clean/delete other cache headers. Default : true.
     * @param mixed $date
     ...
     * @param bool  $sharedCache          True if the lifetime concern a public/shared cache. Default : false.
     * @param bool  $cleanCacheHeaderTrue for clean/delete other cache headers. Default : true.
     * @param mixed $cleanCacheHeader
     */
     ...
     *
     * @param mixed      $dateLastModified Can be a jDateTime object, a DateTime object or a string understandable by strtotime
     * @param bool       $cleanCacheHeader True for clean/delete other cache headers. Default : true.
     * @param null|mixed $etag
     *
     * @return bool True if the client ressource version is fresh, false otherwise
     */
