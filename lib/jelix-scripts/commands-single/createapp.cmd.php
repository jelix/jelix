...
"
    ...
    public function run() {
        ...
        $this->createDir($appPath.'composer-modules');
        ...
        copy(__DIR__.'/../includes/composer.phar', $appPath.'composer.phar');
        ...
        $this->createFile($configPath.'composer.json', 'var/config/composer.json.tpl', $param, "Composer app config file");
