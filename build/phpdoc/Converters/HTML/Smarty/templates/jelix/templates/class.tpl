{include file="inc/header.tpl" eltype="class" hasel=true contents=$classcontents}

{if $conflicts.conflict_type}<p class="warning">Conflicts with classes:</p><ul>
	{section name=me loop=$conflicts.conflicts}
	<li>{$conflicts.conflicts[me]}</li>
	{/section}
    </ul>
{/if}

<div class="leftcol">
	<h2><a href="#class_details">{if $is_interface}Interface{else}Class{/if} Overview</a></h2>
        <p class="notes">
...
{/if}
	...
	<h2>Class Details</h2>
        {include file="inc/docblock.tpl" type="class" sdesc=$sdesc desc=$desc}
	<p class="small" style="color: #334B66;">[ <a href="#top">Top</a> ]</p>

	<hr>
	<a name="class_vars"></a>
	<h2>Class Variables</h2>
        {include file="inc/var.tpl"}

	<hr>
	<a name="class_methods"></a>
	<h2>Class Methods</h2>
        {include file="inc/method.tpl"}

	<hr>
	<a name="class_consts"></a>
	<h2>Class Constants</h2>
        {include file="inc/const.tpl"}
</div>
