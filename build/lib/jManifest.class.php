...
require_once(dirname(__FILE__).'/filesystem/FsOs.php');
require_once(dirname(__FILE__).'/filesystem/FsSvn.php');
require_once(dirname(__FILE__).'/filesystem/FsHg.php');
require_once(dirname(__FILE__).'/filesystem/FsGit.php');
